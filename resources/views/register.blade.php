...
<head>
    ...
    <body>
    <div class="container">
    <form action = "/signin/" class="needs-validation" novalidate method="POST">
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control" name="email" id="validationCustomUsername" placeholder="prova@email.com" aria-describedby="inputGroupPrepend" required>
                    <div class="invalid-feedback">
        ...
        <p align = "center">
            ...
            <button class="btn btn-secondary" type="button"><a href = "{{ url('/') }}"> Back </a></button>
            @method('POST')
            @csrf{{--Token che permette l'attività di registrazione e login --}}
        </p>
    </form>
